	...
	LEER-SEQUENCIAL.
	    READ ARCH-TAR-SEQ.
	    IF SEQ-OK
	       DISPLAY 'OK. COD SEÑ LEIDO: ' REG-TAR-SRT
	    ELSE
	       DISPLAY 'NO PUDO LEER SEQ ' FS-ARCH-TAR-SEQ.

	CARGAR-INDEXADO.
	    MOVE REG-TAR-SEC TO REG-TAR-INDEXED.
	    WRITE REG-TAR-INDEXED.
	    IF IDX-OK
	       DISPLAY 'SE GRABO EL PADRON ' REG-TAR-SRT-IND
	       ADD 1 TO WS-ACUM-REG
	    ELSE
	       DISPLAY 'ERROR DE ESCRITURA ' FS-ARCH-TAR-IDX.
	    PERFORM LEER-SEQUENCIAL.
