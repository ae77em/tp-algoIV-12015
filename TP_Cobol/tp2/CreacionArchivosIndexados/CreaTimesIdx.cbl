	...
	ENTRADA.
		...
		DISPLAY "SE CARGARON EN EL ARCHIVO SORT " WS-ACUM-REG "  REGISTROS".
	...
	CARGAR-REG-SORT.
	    ...
	    DISPLAY REG-TEMP-TIMES-NRO "  " REG-TEMP-TIMES-FECHA "  " REG-TEMP-TIMES-CUIT.   
	...
	SALIDA.
        ...
        PERFORM CARGAR-INDEXADO UNTIL TEMP-EOF.

        CLOSE TIMES-IDX.
        DISPLAY "   ".
        DISPLAY "SE TOMARON " WS-ACUM-REG " REGISTRO DEL ARCHIVO SORT ".
