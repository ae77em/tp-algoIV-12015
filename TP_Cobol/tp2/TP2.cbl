      ...
      PROCEDURE DIVISION.
       ...
       ENTRADA.
          ...
          DISPLAY "INICIANDO INPUT PROCEDURE,    REGISTROS CARGADOS EN EL ARCHIVO PREVIO AL SORT".
          DISPLAY "PARAMETROS MIN: " WS-MIN-CUIT  "  MAX:" WS-MAX-CUIT "  CLAVE para posicionar indice maestro: " REG-KEY-CUIT .
          
          PERFORM CARGAR-ARCHIVO UNTIL REG-KEY-CUIT IS GREATER THAN WS-MAX-CUIT OR TIMES-EOF.
