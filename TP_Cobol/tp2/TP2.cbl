       ...
       OBTENER-DATOS-CONSULTOR.
         ...
         START ARCH-CONS-INDEXED
           KEY IS NOT GREATER OR EQUAL TO REG-T-X-E-COD-CONS.

         READ ARCH-CONS-INDEXED NEXT RECORD.

      *   DISPLAY 'NOMBRE OBTENIDO ' REG-CONS-NOMBRE.
      *   DISPLAY 'SENIORITY OBTENIDO ' REG-CONS-SRT.
