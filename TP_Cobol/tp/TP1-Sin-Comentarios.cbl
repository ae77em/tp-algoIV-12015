       ...
       01 WS-LINEA-VACIA             PIC X(80) VALUE SPACES.
       ...
       CARGAR-MAESTRO.
           ...
           WRITE LINEA-LISTADO FROM WS-LINEA-VACIA AFTER 10.
       ...
       CARGAR-IMP-GENERAL-IMPORTE.
           ...
           WRITE LINEA-LISTADO FROM LINEA-IMPORTE-TOTAL-CONS AFTER 1.
       ...
       CARGAR-IMP-DATOS-X-CONS.
          ...
          WRITE LINEA-LISTADO FROM LINEA-DATOS-POR-CONS .
       ...
       CARGAR-IMPRIMIR-TOTALES-X-FECHA.
           ...
           WRITE LINEA-LISTADO FROM LINEA-DATOS-POR-FECHA AFTER 2.
           WRITE LINEA-LISTADO FROM WS-LINEA-VACIA AFTER 2.
       ...
       CARGAR-E-IMPRIMIR-LINEA-FECHA.
           ...
           WRITE LINEA-LISTADO FROM LINEA-DATOS-POR-TRABAJO AFTER 1.
       ...
       CARGAR-E-IMPRIMIR-PRIMERA-LINEA.
           ...
           WRITE LINEA-LISTADO FROM ENCABE-LINEA1.

           WRITE LINEA-LISTADO FROM ENCABE-LINEA2 AFTER 1.
       ...
       CARGA-E-IMP-ENCABE-CONS.
          ...
          WRITE LINEA-LISTADO FROM ENCABE-CONSULTOR-LINEA1 AFTER 1.

          MOVE WS-CAT-DES TO ENCABE-CONSULTOR-LINEA2-CAT.
          WRITE LINEA-LISTADO FROM ENCABE-CONSULTOR-LINEA2 AFTER 1.

          MOVE WS-CAT-TARIFA TO ENCABE-CONSULTOR-LINEA3-TARIFA.
          WRITE LINEA-LISTADO FROM ENCABE-CONSULTOR-LINEA3 AFTER 1.
          WRITE LINEA-LISTADO FROM WS-LINEA-VACIA AFTER 2.


       IMPRIMIR-ENCABEZADO-POR-FECHA.
          WRITE LINEA-LISTADO FROM ENCABE-CONSULTOR-POR-FECHA.
